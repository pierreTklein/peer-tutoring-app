...
const ACCOUNT_CONFIRM = "Account confirmation successful.";
...
const ACCOUNT_SEND_CONFIRMATION_EMAIL = "Send confirmation email successful.";
...
module.exports = {
  ...
  ACCOUNT_SEND_CONFIRMATION_EMAIL: ACCOUNT_SEND_CONFIRMATION_EMAIL,
